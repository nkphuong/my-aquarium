...
const loginSchema = z.object({
  ...
  password: z.string().min(1, 'Password is required').min(8, 'Password must be at least 8 characters').max(200),
})
      ...
      <div className="relative bg-white rounded-3xl shadow-[0_8px_40px_rgba(13,148,136,0.15)] p-8 md:p-10 border border-border/40 overflow-hidden">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="relative space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-2xl border-2 border-slate-200 bg-white hover:border-primary/30 hover:bg-primary/5 hover:shadow-md transition-all duration-300 group"
            >
              ...
              <span className="font-semibold text-sm text-slate-700 group-hover:text-primary transition-colors">Google</span>
            </button>
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-2xl border-2 border-slate-200 bg-white hover:border-primary/30 hover:bg-primary/5 hover:shadow-md transition-all duration-300 group"
            >
              ...
              <span className="font-semibold text-sm text-slate-700 group-hover:text-primary transition-colors">GitHub</span>
            </button>
          </div>
        </form>
        ...
        <div className="text-center mt-8">
          ...
          <Link
            className="relative ml-2 text-primary hover:text-primary/80 font-bold text-sm transition-all duration-300 inline-flex items-center gap-1"
            href="/register"
          >
            Sign up
